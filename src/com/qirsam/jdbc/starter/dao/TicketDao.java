...
import com.qirsam.jdbc.starter.entity.Flight;
import com.qirsam.jdbc.starter.entity.Ticket;
import com.qirsam.jdbc.starter.exception.DaoException;
...
public class TicketDao implements Dao<Long, Ticket>{
    ...
    public List<Ticket> findAll(TicketFilter filter) {
        ...
        var sql = FIND_ALL_SQL + where; // если в фильтре не будет ни одного параметра, то нужно добавить пустую строку вместо where, чтобы не было ошибки
